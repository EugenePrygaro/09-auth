...
const createNote = async (noteData)=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].post(API_URL, noteData, {
        headers: {
            Authorization: `Bearer ${("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImV1Z2VuZXByeWdhcm9AZ21haWwuY29tIiwiaWF0IjoxNzc2MTg0NDI0fQ.xg3sLC1zzn1nQiD0ptNgBuCst91M7lPJyc0TV8PyuXg")}`
        }
    });
...
const generateMetadata = async ({ params })=>{
    ...
    return {
        title: `Filter: ${slug[0]}`,
        description: tagDescriptions[slug[0]] || "Explore your notes with ease using our filter feature.",
        openGraph: {
            title: `Filter: ${slug[0]}`,
            description: tagDescriptions[slug[0]] || "Explore your notes with ease using our filter feature.",
            siteName: "NoteHub",
...
async function FilterPage({ params }) {
    const { slug } = await params;
    ...
    await queryClient.prefetchQuery({
        queryKey,
        queryFn: ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fetchNotes"])(1, 12, "", isAll ? undefined : tag)
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0gwps5u._.js.map